const CACHE_NAME = 'mkenya-shop-shell-v3';
const APP_SHELL = ['/', '/manifest.webmanifest', '/mkenya-shop-icon.png', '/mkenya-shop-icon-192.png', '/mkenya-shop-icon-512.png', '/favicon.svg'];
